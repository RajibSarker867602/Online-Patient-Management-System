<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssistanceAboutPageUI.aspx.cs" Inherits="PatientManagementApp.UI.AssistanceAboutPageUI" %>
...
<ul>
   ...
   <li class='active'><a href="AssistanceAboutPageUI.aspx"><span>About Us</span></a></li>
    ...
    <h1 style="text-align:center">Patient Management APP</h1>
        ...
        <div class="auto-style1">
            ...
            <h2 class="auto-style1"><b>Rajib Sarker</b></h2>
            <h3 class="auto-style1">Chandpur Polytechnic Institute</h3>
            <h3 class="auto-style1">Diploma In Engineering</h3>
            <h3 class="auto-style1">Computer Technology</h3>
        </div>
